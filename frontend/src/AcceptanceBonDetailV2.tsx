...
export function AcceptanceBonDetailPageV2({ bonNumber, onBack }: { bonNumber: string; onBack: () => void }) {
  const { bons, updateBonStatus, softDeleteBon } = useAppStore();
